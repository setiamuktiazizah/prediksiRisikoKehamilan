    ...
    <div class="container-fluid">
        ...
        <div class="card kartu-custom mb-5">
            <div class="card-header" style="background-color: #9FC088;">
                <p class="m-0 p-0 text-black"><b>Edit Data Basis Pengetahuan</b></p>
            </div>
            <div class="card-body mt-3">
                <form action="{{ route('data-basis-pengetahuan.update', $id_basis_pengetahuan) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
                            <select class="form-select" id="kode_diagnosis" name="kode_diagnosis">
                                ...
                                @foreach ($dataDiagnosis as $diagnosis)
                                    @if (old('kode_diagnosis', $dataBasisPengetahuan['kode_diagnosis']) == $diagnosis->kode_diagnosis)
                        ...
                        <div class="col-sm-5">
                            <select class="form-select" id="kode_gejala" name="kode_gejala">
                                ...
                                @foreach ($dataGejala as $gejala)
                                    @if (old('kode_gejala', $dataBasisPengetahuan['kode_gejala']) == $gejala->kode_gejala)
