            ...
            <div class="card-body mt-3">
                <form action="{{ route('data-diagnosis.update', $id_diagnosis) }}" method="POST">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control @error('kode_diagnosis') is-invalid @enderror" id="kode_diagnosis" name="kode_diagnosis" value="{{ old('kode_diagnosis', $dataDiagnosis['kode_diagnosis']) }}">
                    ...
                    <div class="mb-3 row">
                        <label for="nama_diagnosis" class="col-sm-2 col-form-label text-custom">Nama Diagnosis</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control @error('nama_diagnosis') is-invalid @enderror" id="nama_diagnosis" name="nama_diagnosis" value="{{ old('nama_diagnosis', $dataDiagnosis['nama_diagnosis']) }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-8" id="containerSolusi">
                            @foreach (json_decode($dataDiagnosis['solusi']) as $index => $solusi)
                            <div class="row mb-2">
                                <div class="col-sm-11">
                                    <input type="text" class="form-control mb-2" name="solusi_diagnosis[]" value="{{ $solusi }}">
                                </div>
                                <div class="col-sm-1">
